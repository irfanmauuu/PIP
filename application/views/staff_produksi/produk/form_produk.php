                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="<?php echo base_url() ?>Staff_Produksi/simpan_produk"  method="post">
                                        ...
                                        <div class="field item form-group">
                                           <label class="col-form-label col-md-3 col-sm-3">Total Produk </label>    
                                            <div class="col-md-6 col-sm-6  form-group has-feedback">
                                                <input  type="text" class="form-control" name="total_beras" required="" id="harga" maxlength="8">
                                       ...
                                       <!--  <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                           <label class="col-form-label col-md-3 col-sm-3">Satuan </label>    
                                            <div class="col-md-6 col-sm-6  form-group has-feedback">
                                                <input  type="text" class="form-control" name="kg" required="" id="harga" >
                                                <b class="form-control-feedback right">/Kg</b>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="field item form-group">
                                           <label class="col-form-label col-md-3 col-sm-3">Harga </label>    
                                            <div class="col-md-6 col-sm-6  form-group has-feedback">
                                                <input  type="text" class="form-control" name="harga" required="" id="harga" maxlength="8">
                                            </div>
                                        </div> 
