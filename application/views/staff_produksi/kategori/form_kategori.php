                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="<?php echo base_url() ?>Staff_Produksi/simpan_kategori"  method="post">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input type="text" class="form-control" name="nama_kategori" required="required" maxlength="10">
                                            </div>
                                        </div>
                                        <div class="ln_solid">
