                 ...
                 <div class="row">
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                                 <form action="<?php echo base_url('Admin/laporan_perbulan')?>" method="post">
                                  <div class="row mb-3">
                                    <div class="col">
                                    ...
                                    <div class="col">
                                      ...
                                      <a href="<?php echo base_url('Admin/cetak_laporan_perbulan?m='.base64_encode($month).'&Y='.base64_encode($year))?>" class="btn btn-danger" title="cetak" target=window><i class="fa fa-file-pdf-o"></i></a>
                                      <a href="<?php echo base_url('Admin/export_laporan_perbulan?m='.base64_encode($month).'&Y='.base64_encode($year))?>" class="btn btn-success" title="download"><i class="fa fa-download"></i></a>
                                      <?php } ?>
                                    </div>
