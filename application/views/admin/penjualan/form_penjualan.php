...
?>
                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                                    ...
                                    <!-- <form  method="post" id="form-user" action=simpan_penjualan> -->
                                       <!-- HIDDEN -->
                                       ...
                                       echo'
                                         <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-3">
                                              <select class="form-control" id="id_stok" name=id_stok required="" onchange="changeValue2(this.value)">
                                              <option value="">Pilih</option>';
                                                ...
                                                $no=1;
                                                    ...
                                                    echo'
                                                         <option value="'.$row->id_stok.'">'.$row->nama.', '.$row->stok_produk.' Sak ('.$row->kategori.' , '.$Tgl.')</option>';
                                                       $jsArray2 .= "prdName['" . $row->id_stok . "'] =     
                                                          {
                                                             harga            :'".addslashes($row->harga*$row->satuan_kg)."',
                                                             id_produk          :'".addslashes($row->id_produk)."',
                                            ...
                                            <script type="text/javascript">  
                                                <?php echo $jsArray2; ?>
                                                  function changeValue2(id){
                                                   ...
                                                   document.getElementById('id_produk').value = (prdName[id].id_produk); 
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input  type="text" class="form-control" name="kg"  data-parsley-trigger="change" id='kg' readonly="">
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                             <label class="col-form-label col-md-3 col-sm-3">No SO</label>
                                             <div class="col-md-6 col-sm-6">
                                                <input  type="text" class="form-control" name="no_so"  data-parsley-trigger="change">
                                             </div>
                                        </div>
                                        <div class="field item form-group">
                                      ...
                                      $no=1;
                                       ...
                                       ?>
                                         ...
                                         $sql="SELECT produk.harga,penjualan.qty,satuan_kg, 
                                            ...
                                            FROM penjualan,produk WHERE  penjualan.id_pelanggan='$id_pelanggan' AND penjualan.tipe_sj='$tipe_sj' AND status='belum lunas' AND id_transaksi='$id_transaksi' AND penjualan.id_produk=produk.id_produk ";
            ...
            <script type="text/javascript">
                function simpan(){
                    if(document.getElementById('id_produk').value==""){
                     ...
                     $.ajax({
                         type: 'POST',
                         url: "<?php echo base_url()?>Admin/simpan_penjualan",
                         data: data,
      ...
      echo"<script>
       ...
       window.location='".base_url('admin/data_penjualan')."';
           </script>";
     endif;
      ?>