                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="<?php echo base_url() ?>Admin/simpan_pelanggan"  method="post">
                                        ...
                                        <div class="field item form-group">
                                          ...
                                          <div class="field item form-group">
                                           <label class="col-form-label col-md-3 col-sm-3">Biaya Pengiriman</label>    
                                            <div class="col-md-6 col-sm-6">
                                              <input type="text" id="harga" class="form-control" name="biaya_pengiriman" required="">
                                            </div>
                                        </div> 
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3">No Hp</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input  type="text" class="form-control" name="no_hp"  data-parsley-trigger="change" required="" maxlength="13">
                                            </div>
                                        </div>
                                        <div class="ln_solid">
