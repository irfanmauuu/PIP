                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url() ?>Admin/data_pelanggan" class="btn btn-warning" title="kembali">
                                ...
                                <div class="x_content">
                                    <form action="<?php echo base_url() ?>Admin/edit_pelanggan"  method="post">
                                        ...
                                        <div class="field item form-group">
                                           <label class="col-form-label col-md-3 col-sm-3">Alamat</label>    
                                            <div class="col-md-6 col-sm-6">
                                            <textarea class="form-control" name="alamat" rows="3" style="text-align: justify;"><?php echo $alamat ?></textarea>
                                         
                                              <!-- <textarea class="form-control" name="alamat" rows="2" cols="3" required="" style="text-align-last: left;">
                                                  <?php echo $alamat ?>
                                              </textarea> -->
                                            </div>
                                        </div> 
                                          <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input  type="text" class="form-control" name="biaya_pengiriman"  data-parsley-trigger="change" required="" maxlength="13" id="harga" name="biaya_pengiriman" value="<?php echo $biaya_pengiriman?>">
                                            </div>
                                        </div>
                                        <div class="field item form-group">
