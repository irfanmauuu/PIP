          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" >
              <div class="menu_section">
                <br>
                <br>                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url() ?>Admin/"><i class="fa fa-home"></i> Home </span></a></li>
                  <li><a href="<?php echo base_url() ?>Admin/data_pengguna" ><i class="fa fa-user"></i> Pengguna</a></li>
                  <li><a href="<?php echo base_url() ?>Admin/data_pelanggan" ><i class="fa fa-users"></i> Pelanggan</a></li>
                  <li><a href="<?php echo base_url() ?>Admin/data_penjualan"  ><i class="fa fa-edit"></i> Transaksi Penjualan </a> </li>
                   <li><a><i class="fa fa-file-text"></i> Laporan Penjualan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url()?>Admin/laporan_pertanggal">Pertanggal</a></li>
                      <li><a href="<?php echo base_url()?>Admin/laporan_perhari">Perhari</a></li>
                      <li><a href="<?php echo base_url()?>Admin/laporan_perbulan">Perbulan</a></li>
                      <li><a href="<?php echo base_url()?>Admin/laporan_pertahun">Pertahun</a></li>
                    </ul>
                  </li>
