  ...
  header("Content-Disposition: attachment; filename=Laporan Penjualan Bulan ".$month." ".$year.".xls");
  // ?> 
                                 ...
                                 <table style="width:100%">
                                     ...
                                     foreach ($query as $data)
                                      ...
                                      <tr>
                                        ...
                                        <td class="data"><?php foreach ($query2->result() as $total){ echo ($total->total_kg); } ?></td>                        
                                    ...
                                    <tr>
                                        <td></td><td></td><td></td><td></td><td></td>
                                        <td style="border-top: 1px solid black"> <center>TTD & Nama Lengkap <br>Pejabat Berwenang PT PIP</center>  </td>
                                    </tr>