                 ...
                 <div class="row">
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                                 <form action="<?php echo base_url('Manager/laporan_pertahun')?>" method="post">
                                  <div class="row mb-3">
                                    <div class="col">
                                    ...
                                    <div class="col">
                                      ...
                                      <a href="<?php echo base_url('Manager/cetak_laporan_pertahun?Y='.base64_encode($year))?>" class="btn btn-danger" title="cetak" target=window><i class="fa fa-file-pdf-o"></i></a>
                                      <a href="<?php echo base_url('Manager/export_laporan_pertahun?&Y='.base64_encode($year))?>" class="btn btn-success" title="download"><i class="fa fa-download"></i></a>
                                      <?php } ?>
                                    </div>
                                     ...
                                     foreach ($query as $data)
                                       ...
                                       ?>
                                          <tr>
                                           ...
                                           <td><?php echo htmlentities($data->qty).' Kg';?></td>
                                         ...
                                         $Y=$year;
                                         $sql_total="SELECT SUM(qty)as total_kg, SUM(harga*qty) as total_harga FROM penjualan,produk WHERE  MONTH(tgl) BETWEEN '01' AND '12' AND YEAR(tgl)='$Y' AND produk.id_produk=penjualan.id_produk AND status='lunas'";
