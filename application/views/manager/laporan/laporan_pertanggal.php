                 ...
                 <div class="row">
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                                 <form action="<?php echo base_url('Manager/laporan_pertanggal')?>" method="post">
                                  <div class="row mb-3">
                                    <div class="col">
                                    ...
                                    <div class="col">
                                      ...
                                      <a href="<?php echo base_url('Manager/cetak_laporan_pertanggal?d='.base64_encode($tgl1).'&D='.base64_encode($tgl2))?>" class="btn btn-danger" title="cetak" target=window><i class="fa fa-file-pdf-o"></i></a>
                                      <a href="<?php echo base_url('Manager/export_laporan_pertanggal?d='.base64_encode($tgl1).'&D='.base64_encode($tgl2))?>" class="btn btn-success" title="download"><i class="fa fa-download"></i></a>
                                      <?php } ?>
                                    </div>
                                     ...
                                     foreach ($query as $data)
                                       ...
                                       ?>
                                          <tr>
                                           ...
                                           <td><?php echo htmlentities($data->qty).' ';?></td>
                                           <td><?php echo htmlentities(number_format($data->harga*$data->satuan_kg*$data->qty));?></td>
